...
import { initBoard, attack, getSolution, initAttack, initShip, initCoord, IAmove, getCoord, getBoardOther, placeMovement, movement, rendirse } from '_api/match';
...
export default class OtherBoardResultScreen extends Component {
    constructor(props) {
        super(props);
    ...
    async updateBoard() {
        ...
        var msg = "";
        await getBoardOther(username, accessToken, gameId).then(data => {
